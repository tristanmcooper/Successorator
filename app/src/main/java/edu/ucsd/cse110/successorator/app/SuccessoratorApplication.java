...
public class SuccessoratorApplication extends Application {
    ...
    public void onCreate() {
        ...
        List<Goal> DEFAULT_GOALS = List.of(
            new Goal(1, "Goal 1", false, currDateTime.toString(), "Daily", "H", null),
            new Goal(2, "Goal 2", false, currDateTime.toString(), "Weekly", "W", null),
            new Goal(3, "Goal 3", false, currDateTime.toString(), "Monthly", "S", null),
            new Goal(4, "Goal 4", false, currDateTime.toString(), "Yearly", "E", null)
        );
